...
class CollegeTest {
    ...
    @Test
    public void whenAccountIsOptionalEmptyWithNotFoundAccount() {
        Map<Student, Set<Subject>> students = Map.of(
                new Student("Student1", "000001", "201-18-15"),
                Set.of(
                        new Subject("Math", 70),
    ...
    @Test
    public void whenAccountIsOptionalEmptyWithFoundAccount() {
        Map<Student, Set<Subject>> students = Map.of(
                new Student("Student1", "000001", "201-18-15"),
                Set.of(
                        new Subject("Math", 70),
    ...
    public void whenSubjectIsOptionalNotEmpty() {
        ...
        College college = new College(students);
        assertThat(college
                .findBySubjectName("000002", "Sociology").get().score()).isEqualTo(65);
    }
}